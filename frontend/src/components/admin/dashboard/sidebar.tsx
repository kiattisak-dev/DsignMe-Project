...
export function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <div className={cn(
      ...
      expanded ? "w-64" : "w-20",
      "min-h-screen", // Ensure sidebar spans full height
      className
    )}>
      ...
      <Button 
        ...
        size="icon" 
        className={cn(
          "absolute top-3 right-2 h-8 w-8 rounded-full border shadow-md bg-background",
          expanded ? "right-2" : "right-1" // Adjust positioning
        )}
