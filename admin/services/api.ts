...
export const getFile = (id: string) =>
  apiRequest(`/files/${id}`, { method: "GET" });
export const addCategory = (data: any) =>
  apiRequest("/projects/categories", {
    method: "POST",
    body: JSON.stringify(data),
  });
export const getCategories = () =>
  apiRequest("/projects/categories", { method: "GET" });
export const updateCategory = (id: string, data: any) =>
  apiRequest(`/projects/categories/${id}`, {
    method: "PUT",
    body: JSON.stringify(data),
  });
export const deleteCategory = (id: string) =>
  apiRequest(`/projects/categories/${id}`, { method: "DELETE" });
export const getProjectsByCategory = (category: string) =>
  apiRequest(`/projects/${category}`, { method: "GET" });
export const addProject = (category: string, data: any) =>
  apiRequest(`/projects/${category}`, {
    method: "POST",
    body: JSON.stringify(data),
  });
export const updateProject = (category: string, id: string, data: any) =>
  apiRequest(`/projects/${category}/${id}`, {
    method: "PUT",
    body: JSON.stringify(data),
  });
...
// Service Steps API
export const getAllServiceSteps = (category: string) =>
  apiRequest(`/servicesteps/${category}/service-steps`, { method: "GET" });
export const getServiceStep = (category: string, stepId: string) =>
  apiRequest(`/servicesteps/${category}/service-steps/${stepId}`, {
    method: "GET",
  });
export const addServiceStep = (category: string, data: any) =>
  apiRequest(`/servicesteps/${category}/service-steps`, {
    method: "POST",
    body: JSON.stringify(data),
  });
export const updateServiceStep = (
  category: string,
  stepId: string,
  data: any
) =>
